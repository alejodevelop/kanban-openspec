...
Definir la experiencia de frontend para crear, editar y eliminar boards y columnas desde el dashboard y la vista detallada del tablero, con estados de mutacion claros y sin perder el contexto visible.

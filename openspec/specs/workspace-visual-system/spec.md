...
Definir un sistema visual compartido para el workspace del producto que garantice coherencia entre dashboard y board view en tokens, componentes base y patrones de interaccion.

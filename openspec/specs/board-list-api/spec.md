...
Definir el contrato HTTP para listar los boards disponibles con metadatos de resumen, de modo que el dashboard inicial pueda renderizar opciones de navegacion sin leer cada tablero completo por separado.

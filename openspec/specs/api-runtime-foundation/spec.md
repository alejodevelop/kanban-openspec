...
Definir la base operativa del backend HTTP en `packages/api`, incluyendo arranque del servicio, configuracion centralizada y acceso compartido a PostgreSQL para que los siguientes changes puedan construir endpoints de negocio sobre una plataforma ejecutable.
